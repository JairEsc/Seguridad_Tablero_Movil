...
datos_estatal_2025=read.csv("../Municipal-Delitos-2015-2025_may2025.csv",check.names = F,fileEncoding = "latin1")
...
datos_municipal_2025=read.csv("../Municipal-Delitos-2015-2025_may2025.csv",check.names = T,fileEncoding = "latin1")
