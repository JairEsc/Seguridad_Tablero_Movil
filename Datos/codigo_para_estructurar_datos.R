...
datos_estatal_2025=read.csv("../Municipal-Delitos - Junio 2025 (2015-2025).csv",check.names = F,fileEncoding = "latin1")
...
datos_municipal_2025=read.csv("../Municipal-Delitos - Junio 2025 (2015-2025).csv",check.names = T,fileEncoding = "latin1")
